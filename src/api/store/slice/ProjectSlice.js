...
import {
  CREATE_PROJECT,
  CREATE_PROJECT_SCHEME,
  GET_PROJECT,
  GET_PROJECT_ALL_PANCHAYAT,
  GET_PROJECT_ALL_VILLAAGES,
  GET_PROJECT_PANCHAYAT,
  GET_PROJECT_SCHEME,
  GET_PROJECT_STATUS,
  GET_PROJECT_TEHSIL,
  GET_PROJECT_TYPE,
  GET_PROJECT_VILLAGES,
