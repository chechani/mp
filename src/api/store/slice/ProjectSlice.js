  ...
  endpoints: builder => ({
    ...
    GetAllProject: builder.query({
      query: ({page, limit, village, panchayat, tehsil, status}) => {
        ...
        return {
          url: `api/method/mla.helpdesk.get_projects?${params.toString()}`,
          method: 'GET',
        };
      },
    }),
    ...
    GetProjectVillages: builder.query({
      query: ({panchayat}) => ({
        url: `api/method/mla.helpdesk.get_project_villages?panchayat=${panchayat}`,
        method: 'GET',
      }),
    }),
    ...
    GetProjectPanchayat: builder.query({
      query: ({tehsil}) => ({
        url: `api/method/mla.helpdesk.get_project_panchayat?tehsil=${tehsil}`,
        method: 'GET',
      }),
    }),
    ...
    GetProjectTehsil: builder.query({
      query: () => ({
        url: `api/method/mla.helpdesk.get_project_tehsil`,
        method: 'GET',
      }),
    }),
    // Get all Status
    GetProjectStatus: builder.query({
      query: () => ({
        url: `api/method/mla.helpdesk.get_project_status`,
        method: 'GET',
      }),
    }),
    // Create Project
    CreateProject: builder.mutation({
      query: payload => ({
        url: `api/method/mla.helpdesk.create_project`,
        method: 'POST',
        body: payload,
      }),
    }),
    ...
    GetProjectType: builder.query({
      query: () => ({
        url: `api/method/mla.helpdesk.get_project_type`,
        method: 'GET',
      }),
    }),
    ...
    GetProjectScheme: builder.query({
      query: () => ({
        url: `api/method/mla.helpdesk.get_project_scheme`,
        method: 'GET',
      }),
    }),
    // Get all Panchayat
    GetProjectAllPanchayat: builder.query({
      query: ({tehsil}) => ({
        url: `api/method/mla.helpdesk.get_all_panchayat?tehsil=${tehsil}`,
        method: 'GET',
      }),
    }),
    ...
    GetProjectAllVillages: builder.query({
      query: ({panchayat}) => ({
        url: `api/method/mla.helpdesk.get_all_villages?panchayat=${panchayat}`,
        method: 'GET',
      }),
    }),
    ...
    CreateProjectScheme: builder.mutation({
      query: ({scheme_name}) => ({
        url: `api/method/mla.helpdesk.create_project_scheme?scheme_name=${scheme_name}`,
        method: 'POST',
      }),
    }),
    ...
    updateProjectStatus: builder.mutation({
      query: ({project_name, project_status}) => ({
        url: `api/method/mla.helpdesk.update_project_status`,
        method: 'PUT',
        body: {
          project_name,
          project_status,
